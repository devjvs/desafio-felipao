...
//TODO: Agora implemente uma condição necessária para verificar e exibir se há tesouro na sala e se há montro na sala:
    if (sala == salasComTesouro[0]) {
        print("Tesouro na sala " + sala + "!");
    } else if (sala == salasComMonstro[0]) {
        print("Monstro na sala " + sala + "!");
    } else if (sala == salasComTesouro[1]) {
        print("Tesouro na sala " + sala + "!");
    } else if (sala == salasComMonstro[1]) {
        print("Monstro na sala " + sala + "!");
    } else if (sala == salasComTesouro[2]) {
        print("Tesouro na sala " + sala + "!");
    } else if (sala == salasComMonstro[2]) {
        print("Monstro na sala " + sala + "!");
    }
}